    ...
    <table class="table" style="position: relative; bottom: -114px;">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $post->ratings }}</td>
                <td>
                    <a class="btn btn-primary" href="{{ route('computer.edit',$post->id) }}" role="button">Edit</a>
                    <a class="btn btn-danger" href="{{ route('computer.delete',$post->id) }}" role="button">delet</a>
                </td>
            </tr>
            @endforeach
        </tbody>
