    ...
    <table class="table" style="position: relative; bottom: -114px;">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a class="btn btn-primary" href="{{ route('samsung.edit',$post->id) }}" role="button">Edit</a>
                    <a class="btn btn-danger" href="{{ route('samsung.delete',$post->id) }}" role="button">delet</a>
                </td>
            </tr>
            @endforeach
        </tbody>
